...
import { BOUNDING_DATA_INDEX, COUNT, IS_LEAF, LEFT_NODE, OFFSET, RIGHT_NODE } from './nodeBufferFunctions';

const trianglePool = /* @__PURE__ */ new PrimitivePool(() => new ExtendedTriangle());

MeshBVH.prototype.bvhcast = function (otherBvh: MeshBVH, matrixToLocal: Matrix4,
	callbacks: {
		intersectsRanges: any,
		intersectsRange?: (offset1: number, count1: number, offset2: number, count2: number, depth1: number, index1: number, depth2: number, index2: number) => boolean
		intersectsTriangle?: (triangle: ExtendedTriangle, triangle2: ExtendedTriangle, i1: number, i2: number, depth1: number, index1: number, depth2: number, index2: number) => boolean
	}
)
{
	...
	if (intersectsTriangle)
	{
		...
		if (intersectsRange)
		{
			...
			intersectsRange = function (offset1: number, count1: number, offset2: number, count2: number, depth1: number, index1: number, depth2: number, index2: number)
			{
...
export const bvhcast = (function ()
{
	...
	const _obbMap = new Map<number, OrientedBox>();
	const _aabbMap = new Map<number, Box3>();

	function getAABB(nodeIndex32: number, float32Array: Float32Array)
	{
	...
	function getOBB(nodeIndex32: number, float32Array: Float32Array, matrix: Matrix4)
	{
	...
	return function bvhcast(node1Index32: number, node2Index32: number, matrix2to1: Matrix4, ...args: any[])
	{
	...
	function bvhcastTraverse(
		...
		intersectsRangeFunc: (arg0: number, arg1: number, arg2: number, arg3: number, arg4: number, arg5: any, arg6: number, arg7: any) => any,
...
const bufferStack: ArrayBuffer[] = [];
let _prevBuffer: ArrayBuffer;
let _float32Array: Float32Array;
let _uint16Array: Uint16Array;
let _uint32Array: Uint32Array;
export function setBuffer(buffer: ArrayBuffer)
{
...
// for bvhcast only
const bufferStack2: ArrayBuffer[] = [];
let _prevBuffer2: ArrayBuffer;
let _float32Array2: Float32Array;
let _uint16Array2: Uint16Array;
let _uint32Array2: Uint32Array;

export function setBuffer2(buffer: ArrayBuffer)
{
