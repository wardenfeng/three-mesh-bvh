...
async function init() {
	...
	const gltf = await new GLTFLoader().setMeshoptDecoder( MeshoptDecoder ).loadAsync( './assets/models/nasa-m2020/Perseverance.glb' );
	model = gltf.scene;
